...
5. [cli-reference.md](cli-reference.md) — the complete public CLI: checkout/installed/npx invocation order, workspace and identity selection, every public leaf command, and finite JSON versus JSONL output.
6. [architecture/](architecture/) — the authoritative design, split into 16 numbered chapters ([architecture/README.md](architecture/README.md) is the chapter index):
...
7. [adr/](adr/) — the twelve founding architecture decision records, each with context, decision, alternatives rejected, consequences, falsifier, and migration path:
